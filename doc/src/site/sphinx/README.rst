...
`Crossdata <https://github.com/Stratio/crossdata>`_ version 0.2.0 is needed to interact with this connector.
...
To run Connector Cassandra execute::
    ...
    > target/stratio-connector-cassandra-0.2.0T/bin/stratio-connector-cassandra-0.2.0 start
