...
public final class CassandraExecutor {
     ...
     * @return a {@link com.stratio.meta2.common.result.Result}.
     */
    public static com.stratio.meta2.common.result.Result execute(String query, Session session)
        ...
        try {
            ...
            return com.stratio.meta2.common.result.Result.createExecutionErrorResult(
                "Unsupported operation by C*: " + unSupportException.getMessage());
        } catch (DriverException dex) {
            return com.stratio.meta2.common.result.Result
     ...
     * @return a {@link com.stratio.meta2.common.result.Result}.
     */
    public static com.stratio.meta2.common.result.Result execute(String query,
     ...
     * @return a {@link com.stratio.meta2.common.result.Result} with errors.
     */
    public static com.stratio.meta2.common.result.Result processException(Exception ex) {
