...
public class CassandraExecutor {
     ...
     */
    public static com.stratio.meta.common.result.Result execute(String query, Session session) throws UnsupportedException, ExecutionException {
    ...
    /**
     * Executes a query from a String and return always a Result.
     *
     * @param query   The query in a String.
     * @param session Cassandra datastax java driver session.
     * @return a {@link com.stratio.meta.common.result.Result}.
     */
    public static com.stratio.meta.common.result.Result executeSelect(String query, Session session) throws UnsupportedException, ExecutionException {
        try{
            ResultSet resultSet = session.execute(query);
            return com.stratio.meta.common.result
                .QueryResult.createQueryResult(utils.transformToMetaResultSet(resultSet));
     ...
     * @return a {@link com.stratio.meta.common.result.Result}.
     */
    public static com.stratio.meta.common.result.Result executeSelect(String query, Map<String,String> aliasColumns, Session session) throws UnsupportedException, ExecutionException {
        try{
            ResultSet resultSet = session.execute(query);
            return com.stratio.meta.common.result
                .QueryResult.createQueryResult(utils.transformToMetaResultSet(resultSet,aliasColumns));
        } catch (UnsupportedOperationException unSupportException) {
            LOG.debug("Cassandra executor failed", unSupportException);
            return com.stratio.meta.common.result.Result.createExecutionErrorResult(
                "Unsupported operation by C*: " + unSupportException.getMessage());
    ...
    public static com.stratio.meta.common.result.Result processException(Exception ex){
        if(ex.getMessage() == null){
            return com.stratio.meta.common.result.Result.createExecutionErrorResult("Unknown exception");
        }else{
            return com.stratio.meta.common.result.Result.createExecutionErrorResult(ex.getMessage());
        }
    }
