...
public class CassandraExecutor {
    ...
    /**
     * Executes a query from a String and add the alias in the Result.
     *
     * @param query   The query in a String.
     ...
     * @return a {@link com.stratio.meta.common.result.Result}.
     */
    public static com.stratio.meta.common.result.Result execute(String query, Map<String,String> aliasColumns, Session session) throws UnsupportedException, ExecutionException {
        try{
            ResultSet resultSet = session.execute(query);
            return com.stratio.meta.common.result
